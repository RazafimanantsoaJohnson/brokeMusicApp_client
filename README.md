...
## Screens:
 ...
 ## Home Screen
  ...
  [home screen](https://github.com/RazafimanantsoaJohnson/)
 ## Search Screen
  [search_screen](https://github.com/RazafimanantsoaJohnson/)
 ## Album Screen
  ...
  [album_screen](https://github.com/RazafimanantsoaJohnson/)
 ## Player Screen - And button
  A persistent button showing the currently playing song which will help navigate to the player screen.
  Giving the user more control over the songs being played.
  [player_screen](https://github.com/RazafimanantsoaJohnson/)

 ## Gif illustration
  [illustration](https://github.com/RazafimanantsoaJohnson/)
